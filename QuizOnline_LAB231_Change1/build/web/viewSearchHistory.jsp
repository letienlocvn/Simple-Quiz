            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <table class="contain-table text-center col-sm-12" border="1">
                            ...
                            <c:forEach items="${requestScope.LISTSEARCHSCORE}" var="view" varStatus="counter">
                ...
                <div class="row" >
                    <div class="col-sm-1" style="float: right">
                        <ul class="pagination">
                            <c:forEach var="sizeStudent" begin="1" end="${requestScope.SIZESCORE}">
                                <li class="page-item">
                                    <c:url var="viewHistory" 
                                           value="viewSearchHistory?txtSearch=${param.txtSearch}&pageIndex=${sizeStudent}"/>
                                    <a class="page-link" 
